...
namespace Mediapipe.Unity.Sample.HandLandmarkDetection
{
  public class HandLandmarkerRunner : VisionTaskApiRunner<HandLandmarker>
  {
    ...
    [SerializeField] private int driveHandIndex = 0; // 0=�Ĥ@����
    [SerializeField] private HandCollisionDetector handDriver; // ��A�� HandCollisionDetector ����i��
    ...
    new Mediapipe.Unity.ImageSource.ResolutionStruct(1920, 1080, 30),
      ...
      while (true)
      {
        ...
        private void OnHandLandmarkDetectionOutput(HandLandmarkerResult result, Image image, long timestamp)
        {
            ...
            {
                // ���P���� result ���R�W�i�ण�P�A���o���ɮץΪ��O Tasks.Vision.HandLandmarker
                ...
                try
                {
                    ...
                    // Debug.Log($"[HandResult] t={timestamp} hands={handCount} lm0={lm0}"); // 調試信息已關閉
                }
                catch (System.Exception e)
                {
                    // Debug.LogWarning($"[HandResult] received but cannot read fields: {e.Message}"); // 調試信息已關閉
                }
            }
